...
//        //double sample = sin(2 * M_PI * 440 * time) * SCALE * 0.5;
//        //for (i = 0; i < nBufferFrames; i++) {
//        //    
//        //    //*buffer++ = (MY_TYPE)(lastValues[j] * SCALE * 0.5);
//        //    //lastValues[j] += increment;
//        //    //if (lastValues[j] >= 1.0) lastValues[j] -= 2.0;
//        //    *buffer++ = (MY_TYPE)sample;
//        //}
//    }
//   
//    for (int i = 0; i < nBufferFrames; i++) {
//        for (int c = 0; c < channels; c++) {
//            auto idx = i * channels + c;
//            auto sample = lastValues[i * channels + c];
//            *buffer++ = sample * SCALE * 0.5;
//        }
//    }
//
//    //frameCounter += nBufferFrames;
...
//
//    double* data = (double*)calloc(channels * 4400, sizeof(double));
//
//    double dt = 1.0 / fs;
//    for (int i = 0; i < channels * 4400; i += 2) {
//        double t = i * dt;
//        double sample = sin(2 * M_PI * 440 * t);
//        data[i] = sample;
//        data[i + 1] = sample;
//    }
//
